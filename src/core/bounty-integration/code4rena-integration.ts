 ...
 *
 * This module provides integration with Code4rena contests, allowing the Web3FuzzForge
...
export class Code4renaIntegration {
  ...
  /**
   * Map Web3FuzzForge severity to Code4rena severity
   */
  ...
  generateSubmission(issue: VulnerabilityIssue): Code4renaSubmission {
    ...
    if (issue.proof_of_concept) {
      ...
      poc =
        'This vulnerability was identified through automated security testing with Web3FuzzForge. The system detected a potential security issue based on code analysis and test execution. Further manual verification is recommended.';
    }
...
- [Web3FuzzForge Security Testing Report](${this.testResults.metadata.protocol})
