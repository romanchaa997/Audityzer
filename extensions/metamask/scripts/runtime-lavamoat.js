...
(function () {
  ...
  ;(function () {
        ...
        (functors => {
          ...
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; $h͏_imports([]) /* global globalThis */
 ...
 */$h͏_once.FERAL_STACK_GETTER(FERAL_STACK_GETTER)
          ...
          // === functors[1] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let TypeError; $h͏_imports([['./commons.js', [['TypeError', [$h͏_a => (TypeError = $h͏_a)]]]]])
 ...
 */
          ...
          // === functors[5] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; $h͏_imports([]) // @ts-check
 ...
 */
   ...
   */
      ...
      'LRUCacheMap'
          ...
          // === functors[8] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let makeLRUCacheMap; $h͏_imports([['../make-lru-cachemap.js', [['makeLRUCacheMap', [$h͏_a => (makeLRUCacheMap = $h͏_a)]]]], ['./internal-types.js', []]])
     ...
     */
       ...
       */
        ...
        // don't pay for any extra overhead.
          ...
          // === functors[11] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let arrayPush; $h͏_imports([['./commons.js', [['arrayPush', [$h͏_a => (arrayPush = $h͏_a)]]]]])
 ...
 */
   ...
   */
          ...
          // === functors[15] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let Date, TypeError, apply, construct, defineProperties; $h͏_imports([['./commons.js', [['Date', [$h͏_a => (Date = $h͏_a)]], ['TypeError', [$h͏_a => (TypeError = $h͏_a)]], ['apply', [$h͏_a => (apply = $h͏_a)]], ['construct', [$h͏_a => (construct = $h͏_a)]], ['defineProperties', [$h͏_a => (defineProperties = $h͏_a)]]]]])
   ...
   */
          ...
          // === functors[16] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let Math, TypeError, create, getOwnPropertyDescriptors, objectPrototype; $h͏_imports([['./commons.js', [['Math', [$h͏_a => (Math = $h͏_a)]], ['TypeError', [$h͏_a => (TypeError = $h͏_a)]], ['create', [$h͏_a => (create = $h͏_a)]], ['getOwnPropertyDescriptors', [$h͏_a => (getOwnPropertyDescriptors = $h͏_a)]], ['objectPrototype', [$h͏_a => (objectPrototype = $h͏_a)]]]]])
     ...
     */
          ...
          // === functors[18] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let toStringTagSymbol, iteratorSymbol; $h͏_imports([['./commons.js', [['toStringTagSymbol', [$h͏_a => (toStringTagSymbol = $h͏_a)]], ['iteratorSymbol', [$h͏_a => (iteratorSymbol = $h͏_a)]]]]])
 ...
 */
          ...
          // === functors[20] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let Number, String, TypeError, defineProperty, getOwnPropertyNames, isObject, regexpExec, assert; $h͏_imports([['./commons.js', [['Number', [$h͏_a => (Number = $h͏_a)]], ['String', [$h͏_a => (String = $h͏_a)]], ['TypeError', [$h͏_a => (TypeError = $h͏_a)]], ['defineProperty', [$h͏_a => (defineProperty = $h͏_a)]], ['getOwnPropertyNames', [$h͏_a => (getOwnPropertyNames = $h͏_a)]], ['isObject', [$h͏_a => (isObject = $h͏_a)]], ['regexpExec', [$h͏_a => (regexpExec = $h͏_a)]]]], ['./error/assert.js', [['assert', [$h͏_a => (assert = $h͏_a)]]]]])
 ...
 */
          ...
          // === functors[26] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let FERAL_EVAL, create, defineProperties, freeze, assert; $h͏_imports([['./commons.js', [['FERAL_EVAL', [$h͏_a => (FERAL_EVAL = $h͏_a)]], ['create', [$h͏_a => (create = $h͏_a)]], ['defineProperties', [$h͏_a => (defineProperties = $h͏_a)]], ['freeze', [$h͏_a => (freeze = $h͏_a)]]]], ['./error/assert.js', [['assert', [$h͏_a => (assert = $h͏_a)]]]]])
          ...
          // === functors[27] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let FERAL_REG_EXP, regexpExec, stringSlice; $h͏_imports([['./commons.js', [['FERAL_REG_EXP', [$h͏_a => (FERAL_REG_EXP = $h͏_a)]], ['regexpExec', [$h͏_a => (regexpExec = $h͏_a)]], ['stringSlice', [$h͏_a => (stringSlice = $h͏_a)]]]]])
 ...
 * character strings explicitly. Thus, we avoid rejection by the overly eager rejectDangerousSources.
 *
 * @param {string} src
 * @returns {string}
 */
 ...
 */$h͏_once.mandatoryTransforms(mandatoryTransforms)
          ...
          // === functors[29] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let arrayFilter, arrayIncludes, getOwnPropertyDescriptor, getOwnPropertyNames, objectHasOwnProperty, regexpTest; $h͏_imports([['./commons.js', [['arrayFilter', [$h͏_a => (arrayFilter = $h͏_a)]], ['arrayIncludes', [$h͏_a => (arrayIncludes = $h͏_a)]], ['getOwnPropertyDescriptor', [$h͏_a => (getOwnPropertyDescriptor = $h͏_a)]], ['getOwnPropertyNames', [$h͏_a => (getOwnPropertyNames = $h͏_a)]], ['objectHasOwnProperty', [$h͏_a => (objectHasOwnProperty = $h͏_a)]], ['regexpTest', [$h͏_a => (regexpTest = $h͏_a)]]]]])
 ...
 */
      ...
      isImmutableDataProperty(globalObject, name))
          ...
          // === functors[30] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let FERAL_FUNCTION, arrayJoin, apply, getScopeConstants; $h͏_imports([['./commons.js', [['FERAL_FUNCTION', [$h͏_a => (FERAL_FUNCTION = $h͏_a)]], ['arrayJoin', [$h͏_a => (arrayJoin = $h͏_a)]], ['apply', [$h͏_a => (apply = $h͏_a)]]]], ['./scope-constants.js', [['getScopeConstants', [$h͏_a => (getScopeConstants = $h͏_a)]]]]])
 ...
 */
          ...
          !weaksetHas(virtualizedNativeFunctions, this)) {
                ...
                defineProperty(functionPrototype, 'toString', { value: tamingMethods.toString })
          ...
          // === functors[34] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let functionPrototype, getPrototypeOf, globalThis, objectPrototype, setPrototypeOf; $h͏_imports([['./commons.js', [['functionPrototype', [$h͏_a => (functionPrototype = $h͏_a)]], ['getPrototypeOf', [$h͏_a => (getPrototypeOf = $h͏_a)]], ['globalThis', [$h͏_a => (globalThis = $h͏_a)]], ['objectPrototype', [$h͏_a => (objectPrototype = $h͏_a)]], ['setPrototypeOf', [$h͏_a => (setPrototypeOf = $h͏_a)]]]]])
        ...
        ModuleSourceProto.prototype
          ...
          // === functors[35] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let WeakSet, arrayFilter, arrayFlatMap, arrayMap, arrayPop, arrayPush, defineProperty, freeze, fromEntries, isError, stringEndsWith, stringIncludes, stringSplit, weaksetAdd, weaksetHas; $h͏_imports([['../commons.js', [['WeakSet', [$h͏_a => (WeakSet = $h͏_a)]], ['arrayFilter', [$h͏_a => (arrayFilter = $h͏_a)]], ['arrayFlatMap', [$h͏_a => (arrayFlatMap = $h͏_a)]], ['arrayMap', [$h͏_a => (arrayMap = $h͏_a)]], ['arrayPop', [$h͏_a => (arrayPop = $h͏_a)]], ['arrayPush', [$h͏_a => (arrayPush = $h͏_a)]], ['defineProperty', [$h͏_a => (defineProperty = $h͏_a)]], ['freeze', [$h͏_a => (freeze = $h͏_a)]], ['fromEntries', [$h͏_a => (fromEntries = $h͏_a)]], ['isError', [$h͏_a => (isError = $h͏_a)]], ['stringEndsWith', [$h͏_a => (stringEndsWith = $h͏_a)]], ['stringIncludes', [$h͏_a => (stringIncludes = $h͏_a)]], ['stringSplit', [$h͏_a => (stringSplit = $h͏_a)]], ['weaksetAdd', [$h͏_a => (weaksetAdd = $h͏_a)]], ['weaksetHas', [$h͏_a => (weaksetHas = $h͏_a)]]]], ['./types.js', []], ['./internal-types.js', []]])
 ...
 */
   ...
   */
     ...
     */
          ...
          // === functors[36] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let FinalizationRegistry, Map, mapGet, mapDelete, WeakMap, mapSet, finalizationRegistryRegister, weakmapSet, weakmapGet, mapEntries, mapHas; $h͏_imports([['../commons.js', [['FinalizationRegistry', [$h͏_a => (FinalizationRegistry = $h͏_a)]], ['Map', [$h͏_a => (Map = $h͏_a)]], ['mapGet', [$h͏_a => (mapGet = $h͏_a)]], ['mapDelete', [$h͏_a => (mapDelete = $h͏_a)]], ['WeakMap', [$h͏_a => (WeakMap = $h͏_a)]], ['mapSet', [$h͏_a => (mapSet = $h͏_a)]], ['finalizationRegistryRegister', [$h͏_a => (finalizationRegistryRegister = $h͏_a)]], ['weakmapSet', [$h͏_a => (weakmapSet = $h͏_a)]], ['weakmapGet', [$h͏_a => (weakmapGet = $h͏_a)]], ['mapEntries', [$h͏_a => (mapEntries = $h͏_a)]], ['mapHas', [$h͏_a => (mapHas = $h͏_a)]]]]])
              ...
              if (originalConsole && originalConsole.log) {
                for (const methodName of ['warn', 'error']) {
                  if (!originalConsole[methodName]) {
                    defineProperty(originalConsole, methodName, { value: wrapLogger(originalConsole.log, originalConsole) })
                  }
                }
              }
   ...
   */
              ...
              const systemPrepareFnFor = (inputPrepareFn) => {
                ...
                const systemMethods = {
                  prepareStackTrace(error, sst) {
                    weakmapSet(stackInfos, error, { callSites: sst })
                    return inputPrepareStackTraceFn(error, safeV8SST(sst))
                  }
                }
        ...
        moduleSpecifier)
            ...
            const memoizedLoadWithErrorAnnotation = (
              ...
              moduleLoading = selectImplementation(asyncTrampoline, syncTrampoline)(
                ...
                (error) => {
                  // eslint-disable-next-line no-polymorphic-call
                  annotateError(
                    error,
 ...
 */$h͏_once.moderateEnablements(moderateEnablements);
            const severeEnablements = {
              ...
              /**
               * @type {Enablement}
               * @property {boolean} [severe.allowFunctionToString]
               * @property {boolean} [severe.allowFunctionToStringTag]
@@ -6558,8 +6566,9 @@
  * strictScopeTerminatorHandler manages a scopeTerminator Proxy which serves as
  * the final scope boundary that will always return "undefined" in order
  * to prevent access to "start compartment globals". When "sloppyGlobalsMode"
    ...
    options
      ...
      arraySome(moduleSource.exports, (name) => typeof name !== 'string')) {
         ...
         `SES virtual module source "exports" property must be an array of strings for module ${moduleSpecifier}`)
               ...
               const localState = { activated: false }
    ...
    '__options__' in args[0]) {
       ...
       `Compartment constructor only supports true __options__ sigil, got ${__options__}`)
        ...
        compartmentOptions(...args)
          ...
          // === functors[46] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let FERAL_FUNCTION, Float32Array, Map, Set, String, getOwnPropertyDescriptor, getPrototypeOf, iterateArray, iterateMap, iterateSet, iterateString, matchAllRegExp, matchAllSymbol, regexpPrototype, globalThis, InertCompartment; $h͏_imports([['./commons.js', [['FERAL_FUNCTION', [$h͏_a => (FERAL_FUNCTION = $h͏_a)]], ['Float32Array', [$h͏_a => (Float32Array = $h͏_a)]], ['Map', [$h͏_a => (Map = $h͏_a)]], ['Set', [$h͏_a => (Set = $h͏_a)]], ['String', [$h͏_a => (String = $h͏_a)]], ['getOwnPropertyDescriptor', [$h͏_a => (getOwnPropertyDescriptor = $h͏_a)]], ['getPrototypeOf', [$h͏_a => (getPrototypeOf = $h͏_a)]], ['iterateArray', [$h͏_a => (iterateArray = $h͏_a)]], ['iterateMap', [$h͏_a => (iterateMap = $h͏_a)]], ['iterateSet', [$h͏_a => (iterateSet = $h͏_a)]], ['iterateString', [$h͏_a => (iterateString = $h͏_a)]], ['matchAllRegExp', [$h͏_a => (matchAllRegExp = $h͏_a)]], ['matchAllSymbol', [$h͏_a => (matchAllSymbol = $h͏_a)]], ['regexpPrototype', [$h͏_a => (regexpPrototype = $h͏_a)]], ['globalThis', [$h͏_a => (globalThis = $h͏_a)]]]], ['./compartment.js', [['InertCompartment', [$h͏_a => (InertCompartment = $h͏_a)]]]])
 ...
 */
    ...
    RegExpStringIterator && getPrototypeOf(RegExpStringIterator)
          ...
          // === functors[47] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let TypeError, freeze; $h͏_imports([['./commons.js', [['TypeError', [$h͏_a => (TypeError = $h͏_a)]], ['freeze', [$h͏_a => (freeze = $h͏_a)]]]]])
 ...
 */
          ...
          // === functors[49] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let getOwnPropertyDescriptor, apply, defineProperty, toStringTagSymbol; $h͏_imports([['./commons.js', [['getOwnPropertyDescriptor', [$h͏_a => (getOwnPropertyDescriptor = $h͏_a)]], ['apply', [$h͏_a => (apply = $h͏_a)]], ['defineProperty', [$h͏_a => (defineProperty = $h͏_a)]], ['toStringTagSymbol', [$h͏_a => (toStringTagSymbol = $h͏_a)]]]]])
 ...
 */
            const tameFauxDataProperty = (obj, prop, expectedValue) => {
              ...
              // override mistake problem while in this temporary state.
 ...
 */$h͏_once.tameFauxDataProperty(tameFauxDataProperty)
          ...
          // === functors[50] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let defineProperty, iteratorPrototype, iteratorSymbol, objectHasOwnProperty; $h͏_imports([['./commons.js', [['defineProperty', [$h͏_a => (defineProperty = $h͏_a)]], ['iteratorPrototype', [$h͏_a => (iteratorPrototype = $h͏_a)]], ['iteratorSymbol', [$h͏_a => (iteratorSymbol = $h͏_a)]], ['objectHasOwnProperty', [$h͏_a => (objectHasOwnProperty = $h͏_a)]]]]])
   ...
   */
      ...
      assert.fail(
        ...
        TypeError)
          ...
          // === functors[53] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let globalThis, repairIntrinsics; $h͏_imports([['./assert-sloppy-mode.js', []], ['./commons.js', [['globalThis', [$h͏_a => (globalThis = $h͏_a)]]]], ['./lockdown.js', [['repairIntrinsics', [$h͏_a => (repairIntrinsics = $h͏_a)]]]]])
 ...
 */
          ...
          // === functors[55] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let globalThis, assert; $h͏_imports([['./commons.js', [['globalThis', [$h͏_a => (globalThis = $h͏_a)]]]], ['./error/assert.js', [['assert', [$h͏_a => (assert = $h͏_a)]]]]])

            globalThis.assert = assert
          })(),
          // === functors[56] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; let symbolFor, globalThis, defineCausalConsoleFromLogger, loggedErrorHandler; $h͏_imports([['./commons.js', [['symbolFor', [$h͏_a => (symbolFor = $h͏_a)]], ['globalThis', [$h͏_a => (globalThis = $h͏_a)]]]], ['./error/console.js', [['defineCausalConsoleFromLogger', [$h͏_a => (defineCausalConsoleFromLogger = $h͏_a)]]]], ['./error/assert.js', [['loggedErrorHandler', [$h͏_a => (loggedErrorHandler = $h͏_a)]]]]])
 ...
 */
  ...
  makeCausalConsoleFromLoggerForSesAva
          ...
          // === functors[57] ===
          ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta }) => (function () {
            'use strict'; $h͏_imports([['./src/lockdown-shim.js', []], ['./src/compartment-shim.js', []], ['./src/assert-shim.js', []], ['./src/console-shim.js', []]])
          })(),
        ])
