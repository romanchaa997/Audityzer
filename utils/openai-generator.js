...
function getOpenAIClient() {
  if (!process.env.OPENAI_API_KEY) {
    throw new Error('OPENAI_API_KEY is not set in environment variables. Please set it in your .env file or as an environment variable.')
  }
...
async function generateConfigFromPrompt(prompt) {
  try {
    ...
    try {
      ...
      console.log(chalk.yellow('Generated content was not valid JSON. Please try again with a clearer prompt.'))
