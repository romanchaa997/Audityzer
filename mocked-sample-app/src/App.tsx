      ...
      try {
        if (window.ethereum?.selectedAddress) {
          ...
          if (window.ethereum.chainId) {
            ...
            setNetworkName(networkNames[window.ethereum.chainId] || `Chain ID: ${window.ethereum.chainId}`)
          }
    ...
    <div className="app">
      ...
      <main>
        ...
        <div className="card">
          ...
          <p className="note">
            This is a mock transaction that will request approval from your wallet.
            No actual funds will be transferred in test mode.
          </p>
        </div>
      </main>
