...
- Name: Wallet State Snapshot Demo >> Use wallet state to test transaction flows
- Location: F:\Ігор\web3-security-test-kit\tests\wallet-snapshot.test.js:291:3
...
Received string:    "Not connected"
    ...
    at F:\Ігор\web3-security-test-kit\tests\wallet-snapshot.test.js:293:5
```
