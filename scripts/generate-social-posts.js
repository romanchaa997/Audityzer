...
const twitter = [
  `🚀 Introducing Audityzer v${pkg.version}!\n\nAn intelligent dev server 🔒 built for Web3 security testing.\n\nZero-config → smart port management → integrated Playwright & Lighthouse CI.\n\n${utm} #Web3 #DevOps #Security`,
  `Why Audityzer?\n• Auto-detects port conflicts\n• Runs security tests on every save\n• Cross-platform (Win/Mac/Linux)\n\nGive it a spin: npm i -g audityzer && audityzer dev\n\n${utm}`
].join('\n\n---\n\n');

// LinkedIn post
const linkedin = `🚀 We just launched Audityzer v${pkg.version} – an intelligent development server engineered for Web3 security testing.\n\nHighlights:\n• Automatic port conflict resolution\n• Built-in Playwright & Lighthouse testing\n• Cross-platform & Docker-ready\n\nTry it today 👉 npm i -g audityzer\n\n${utm}`;

// Reddit post
const reddit = `Title: [Launch] Audityzer – An intelligent dev server for Web3 security testing\n\nBody:\nHey r/webdev & r/ethereum!\n\nWe just open-sourced Audityzer v${pkg.version}. It auto-manages ports, injects security testing hooks, & bundles Lighthouse CI out-of-the-box. Looking for feedback from power users – all constructive criticism welcome!\n\nSource & docs: ${url}\n\nCheers!`;
