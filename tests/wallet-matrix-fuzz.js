 ...
 *
 * Generated by Web3FuzzForge - yarn forge:gen tx --wallet metamask,coinbase,walletconnect --fuzz
 */
  ...
  if (isSnapshotMode) {
    ...
    if (changes.changes.length > 0) {
      ...
      changes.changes.forEach(change => {
        console.log(`- ${change.type} (${change.severity}): ${change.before} → ${change.after}`);
      });
    } else {
