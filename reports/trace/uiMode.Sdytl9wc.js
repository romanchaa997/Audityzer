  ...
  filterTree(t, e, s) {
    const i = t.trim().toLowerCase().split(' '),
      ...
      a = l => {
        ...
        return !i.every(n => _.includes(n)) &&
          !l.tests.some(n => (s == null ? void 0 : s.has(n.id)))
          ? !1
          : ((l.children = l.children.filter(
              n => !c || (s == null ? void 0 : s.has(n.test.id)) || e.get(n.status)
            )),
...
function xt(r) {
  ...
  r.kind === 'group' &&
    r.children.sort(
      (a, g) => a.location.file.localeCompare(g.location.file) || a.location.line - g.location.line
    );
                        ...
                        children: [
                          o.jsx('input', {
                            ...
                            onChange: () => {
                              ...
                              x.set(d, !x.get(d)), c(x);
                              const B =
                                (C = a == null ? void 0 : a.config) == null ? void 0 : C.configFile;
                              B &&
                                vt.setObject(
                                  B + ':projects',
...
const _e = ({ item: r, rootDir: t, onOpenExternally: e, revealSource: s, pathSeparator: i }) => {
    ...
    const [c, a] = u.useState(void 0),
      ...
      { outputDir: n } = u.useMemo(
        () => ({ outputDir: r.testCase ? we(r.testCase) : void 0 }),
        [r]
      );
    return (
      u.useEffect(() => {
