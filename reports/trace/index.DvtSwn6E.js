...
const I = ({
    ...
    return (
      ...
      o &&
        e.jsx('dialog', { ref: w, style: S, className: n, 'data-testid': E, open: !0, children: y })
    );
  },
  V = (n, d) => {
    const o = R(n, d, 'left');
      ...
      L = s.useCallback(t => {
        ...
        for (let l = 0; l < t.length; l++) {
          ...
          a.push(k),
            ...
            r.searchParams.append('traceFileName', m.name);
        }
        const v = r.toString();
        ...
        (async () => {
          if (o.length) {
            ...
            for (let r = 0; r < o.length; r++) {
              ...
              l.set('trace', v),
                f.length && l.set('traceFileName', f[r]),
                l.set('limit', String(o.length));
              ...
              e.jsx('button', {
                onClick: () => {
                  ...
                  (t.type = 'file'),
                    (t.multiple = !0),
                    t.click(),
                    t.addEventListener('change', a => P(a));
                },
                type: 'button',
