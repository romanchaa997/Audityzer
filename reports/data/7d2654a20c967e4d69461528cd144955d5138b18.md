...
- Name: Wallet State Snapshot Demo >> Setup wallet state and switch networks
- Location: F:\Ігор\web3-security-test-kit\tests\wallet-snapshot.test.js:245:3
...
Received string:    "Not connected"
    ...
    at F:\Ігор\web3-security-test-kit\tests\wallet-snapshot.test.js:247:5
```
...
- paragraph: "Address: Not connected"
- paragraph: "Network: Unknown"
