...
export interface DappeteerPage<P = unknown> {
    ...
    $eval<T>(selector: string, evalFn: (e: HTMLElement) => Promise<T> | T): Promise<T>;
    $$eval<T>(selector: string, evalFn: (e: HTMLElement[]) => Promise<T[]> | T[]): Promise<T[]>;
    ...
    waitForFunction<Params extends Serializable>(pageFunction: Function | string, params?: Params): Promise<void>;
...
export declare type Unboxed<Arg> = Arg extends DappeteerElementHandle<any, infer T> ? T : Arg extends [infer A0] ? [Unboxed<A0>] : Arg extends [infer A0, infer A1] ? [Unboxed<A0>, Unboxed<A1>] : Arg extends [infer A0, infer A1, infer A2] ? [Unboxed<A0>, Unboxed<A1>, Unboxed<A2>] : Arg extends [infer A0, infer A1, infer A2, infer A3] ? [Unboxed<A0>, Unboxed<A1>, Unboxed<A2>, Unboxed<A3>] : Arg extends Array<infer T> ? Array<Unboxed<T>> : Arg extends object ? {
