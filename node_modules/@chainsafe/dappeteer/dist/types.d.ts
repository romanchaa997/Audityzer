...
export declare type DappeteerLaunchOptions = {
    metaMaskVersion?: typeof RECOMMENDED_METAMASK_VERSION | "latest" | "local" | string;
...
export declare type CustomAutomation = (metamaskPath: string, userDataDir: string, options: DappeteerLaunchOptions) => Promise<DappeteerBrowser>;
declare global {
    interface Window {
...
export declare type Dappeteer = {
    ...
    snaps: {
         ...
         */
        invokeSnap: <Result = unknown, Params extends Serializable = Serializable>(page: DappeteerPage, snapId: string, method: string, params?: Params) => Promise<Partial<Result>>;
        /**
         ...
         */
        installSnap: (snapIdOrLocation: string, opts?: {
